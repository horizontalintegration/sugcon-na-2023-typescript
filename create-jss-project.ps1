...
Function Add-JssProject {
  ...
  Push-Location src
  try {
    $projectName = "sugcon-na-2023-typescript"
    ...
    $jssProjectName = "sugcon-na--typescript"
    ...
    try {
      jss setup `
        ...
        --layoutServiceHost "https://cm.sugcon_na_2023_typescript.localhost" `
        --apiKey "8EE743C5-2B9A-49A2-BAAF-BEB30D623245" `
        --deployUrl "https://cm.sugcon_na_2023_typescript.localhost/sitecore/api/jss/import" `
        --deploySecret "6B908E3FB0D8439689BC35302F632E71" `
        --nonInteractive `

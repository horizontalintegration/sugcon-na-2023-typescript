...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sugcon_na_2023_typescript.localhost"
...
Add-HostsEntry "cm.sugcon_na_2023_typescript.localhost"
Add-HostsEntry "id.sugcon_na_2023_typescript.localhost"
Add-HostsEntry "www.sugcon_na_2023_typescript.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sugcon_na_2023_typescript.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sugcon_na_2023_typescript.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.sugcon_na_2023_typescript.localhost"

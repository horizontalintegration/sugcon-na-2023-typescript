...
* `sugcon-na-2023-typescript.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `sugcon-na-2023-typescript-Content.module.json` contains content items which are
